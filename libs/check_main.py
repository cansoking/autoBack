...
def cv2ImgAddText(img, text, left, top, textColor=(255, 0, 0), textSize=20):
    ...
    # 字体的格式
    fontStyle = ImageFont.truetype("fonts/ANTQUAB.TTF", textSize, encoding="utf-8")
    # 绘制文本
...
# %%
def check_image(path, save=False, save_path='static/question_image/after/result.jpg'):
    # 返回数据
    questions = []
    ...
    model.load_weights('libs/checkpoint/char_checkpoint')
    class_name = np.load('libs/checkpoint/class_name.npy')
